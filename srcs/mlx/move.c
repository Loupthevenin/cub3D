...
/*   Updated: 2025/02/20 18:47:49 by opdi-bia         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	move_up_down(int keycode, t_game *game, double move_speed)
{
    if (keycode == XK_s)
    {
        if (game->config->map[(int)(game->player.pos_y - (game->player.dir_y * move_speed * 2))][(int)(game->player.pos_x)] == '0')  
            game->player.new_y -= (game->player.dir_y * move_speed);

        if (game->config->map[(int)(game->player.pos_y)][(int)(game->player.pos_x - (game->player.dir_x * move_speed * 2))] == '0')  
...
int	move_left_right(int keycode, t_game *game, double move_speed)
{
	if (keycode == XK_a)
	{
		if(game->config->map[(int)(game->player.pos_y)][(int)(game->player.pos_x + (game->player.dir_y * move_speed * 2))] == '0')
			 game->player.new_x += (game->player.dir_y * move_speed);
		if(game->config->map[(int)(game->player.pos_y - (game->player.dir_x * move_speed * 2))][(int)(game->player.new_x)] == '0') 
